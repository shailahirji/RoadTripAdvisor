...
exports.autocomplete = {
  ...
  validator: validate.construct([validate.together(['boundaryLeft', 'boundaryRight', 'boundaryTop', 'boundaryBottom']), validate.object({
...
var _analytics = __webpack_require__(/*! ./api/analytics */ "./src/api/analytics.js");
...
function create() {
  ...
  return {
    ...
    routeMatching: createApiMethod(_routing.routeMatching),
    ...
    mapMatching: createApiMethod(_analytics.mapMatching),
    speedingReport: createApiMethod(_analytics.speedingReport)
  };
}
...
var InstanceId = function InstanceId() {
...
var _instanceId = __webpack_require__(/*! ../util/instanceId */ "./src/util/instanceId.js");
