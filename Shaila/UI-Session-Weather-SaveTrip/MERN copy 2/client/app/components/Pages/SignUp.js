...
class SignUp extends Component {
  ...
  renderRedirect() {
    if (this.state.redirect) {
      ...
      return <Redirect to={{ pathname: "/SignIn" , state: this.state }} />; //allowing user to sign in
    }
  }
  ...
  render() {
    ...
    return (
      <div  >
        <div class="home_background" style={{ "backgroundImage": "url(images/home.jpg)", height: "100vh"}}>
