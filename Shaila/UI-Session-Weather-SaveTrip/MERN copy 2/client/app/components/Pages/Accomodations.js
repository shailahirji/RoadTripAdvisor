              ...
              <div class="col">
                <div class="home_content">
                  ...
                  >
                    ...
                    <p style={{ color: "white" }}>
                      Excursion helps you find different accomodations. Check
                      out th elist we have:
                    </p>
                    <ul>
                      <li style={{ color: "white" }}>
                        <a href="www.airbnb.com">Airbnb.com</a>
                      </li>
                      <li style={{ color: "white" }}>
                      ...
                      <li style={{ color: "white" }}>
                        <a href="https://www.Trivago.com/">Trivago</a>
                      </li>
                      <li style={{ color: "white" }}>
                        <a href="https://www.nomadicmatt.com/">Nomadic Matt</a>
                      </li>
                    </ul>
                  </div>
                </div>
